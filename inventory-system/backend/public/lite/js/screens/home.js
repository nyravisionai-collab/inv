...
(function () {
  ...
  function drawResults() {
    ...
    var groups = [
      ...
      { key: 'customers', label: t('customers'), nav: function (it) { return "Lite.go('partyDetail','customer'," + Number(it.id) + ')'; },
        sub: function (it) { return it.phone || ''; } },
      { key: 'suppliers', label: t('suppliers'), nav: function (it) { return "Lite.go('partyDetail','supplier'," + Number(it.id) + ')'; },
        sub: function (it) { return it.phone || ''; } },
